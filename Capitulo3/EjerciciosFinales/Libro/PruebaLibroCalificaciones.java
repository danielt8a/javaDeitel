...
public class PruebaLibroCalificaciones{
	...
	public static void main(String[] args){
		...
		LibroCalificaciones miLibroCalificaciones = 
			new LibroCalificaciones("Fundamentos de Java", "Deitel");
		...
		System.out.printf("El nombre inicial del curso es: %s \n \nEste curso es presentado por: %s\n",
							...
							miLibroCalificaciones.obtenerInstructor());
		...
		//Pide y recibe el nombre del profesor
		System.out.println("Escriba el nombre del profesor: ");
		String profesor = entrada.nextLine();
		miLibroCalificaciones.establecerInstructor(profesor);
